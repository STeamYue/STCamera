...
- (id)init
{
    ...
    _toneLevelValue = 0.47;
    _beautyLevelValue = 0.42;
    _brightLevelValue = 0.34;
    [self setParams:_beautyLevelValue
               tone:_toneLevelValue];
    [self setBrightLevelValue:_brightLevelValue];
    return self;
}
...
#pragma - 美颜 等级（Getter）
- (void)setBeautyLevelValue:(CGFloat)beautyLevelValue{
    _beautyLevelValue = beautyLevelValue;
    [self setParams:_beautyLevelValue
               tone:_toneLevelValue];
}
#pragma - 美白 等级（Getter）
- (void)setBrightLevelValue:(CGFloat)brightLevelValue{
    _brightLevelValue = brightLevelValue;
    [self setFloat:0.6 * (-0.5 + brightLevelValue)
    forUniformName:@"brightness"];
}
